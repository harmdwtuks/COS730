...
namespace InteractionLayer.Providers
{
    public class JwtProvider
    {
        ...
        {
            JObject fromObj = JObject.Parse(payload.ToString());


            //decode the payload from token
            //in order to create a claim
            string userId = fromObj["UserId"].ToString();
            string[] roles = JsonConvert.DeserializeObject<string[]>(fromObj["UserRole"].ToString());
